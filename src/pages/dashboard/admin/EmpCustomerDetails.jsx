...
// Updated fieldConfig with type and endpoint
const fieldConfig = {
  personal: {
    fields: {
...
const EmpCustomerDetails = () => {
  ...
  const fetchCustomerDetails = useCallback(async () => {
    ...
    try {
      ...
      if (error.response?.status === 404) {
        navigate('/dashboard/admin/all-customers');
      }
  ...
  const handleCopy = (data) => {
    ...
    const formatDataAsText = (data) => {
      ...
      const currencyFields = ['total_property_value'];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
          ...
          <button
            onClick={() => navigate('/dashboard/admin/all-customers')}
