...
// Avatar color palette, matching SpecialSearch
...
function LiveCustomers() {
  ...
  // Format height (aligned with SpecialSearch)
  ...
  const fetchCustomers = useCallback(async () => {
    ...
    try {
      ...
      setCustomers([]);
      setFetchError('Failed to load live customers. Please try refreshing.');
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
        ...
        {!loading && !fetchError && (
          filteredCustomers.length > 0 ? (
              ...
              {filteredCustomers.map((customer, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-md font-normal text-gray-900 leading-tight mb-0.5 flex items-center gap-1 dark:text-gray-100"> 
                    ...
                    <p className="text-xs text-gray-600 mb-1 dark:text-gray-400">ID: {customer.user_id}</p> 
            ...
            <div className="text-center py-10">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">No live customers found matching your criteria.</p>
            </div>
          )
        )}
