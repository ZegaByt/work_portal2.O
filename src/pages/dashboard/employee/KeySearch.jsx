  ...
  if (imageUrlToDisplay) {
    return (
      <img
        ...
        loading="lazy"
        className="flex-shrink-0 w-12 h-12 rounded-full object-cover shadow-md" // Decreased size to match EmpAllCustomers
        onError={handleImageError}
      />
    );
  } else {
    return (
      <div className={`flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-lg font-normal shadow-md ${bgColorClass} ${textColorClass}`}> {/* Decreased size to match EmpAllCustomers */}
...
function KeyToSearch() {
  ...
  const renderFilterSelect = (id, label, value, onChange, options) => (
    <div className="relative flex-1 min-w-[100px] sm:min-w-[120px]"> {/* Added flex-1 and min-width for responsiveness */}
  ...
  return (
    <main className="min-h-screen  dark:text-gray-200">
      <div className="w-full px-0 sm:px-0 lg:px-0 py-0">
        <div className=" rounded-xl  p-2 sm:p-1 ">
          <h1 className="text-2xl font-normal text-gray-900 mb-2 text-center dark:text-gray-100">
            Customer Search
          </h1>

          {/* Search and Filter Controls - Adjusted to display in a single row on larger screens */}
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-end gap-x-2 gap-y-3 mb-6"> {/* Changed to flex-row and flex-wrap, reduced gap */}
            <div className="relative flex-1 min-w-[180px] sm:min-w-[200px] lg:min-w-[220px]"> {/* Adjusted min-width for search bar */}
            ...
            <div className="relative flex-1 min-w-[100px] sm:min-w-[120px]">
              <label htmlFor="filterAccountStatus" className="block text-xs font-medium text-gray-700 mb-0.5 dark:text-gray-300">
                Account Status
              </label>
              <select
            ...
            <div className="w-full flex justify-end sm:w-auto sm:ml-auto gap-2"> {/* Adjusted for alignment on smaller screens, ml-auto for pushing to right */}
              <button
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-500 w-full flex flex-col items-center">
                        <div className="flex justify-center items-center gap-2 flex-wrap">
                          ...
                          {(customer.gender !== null && customer.gender !== undefined && customer.height !== null && customer.height !== undefined) && <span className="text-gray-300 dark:text-gray-600 text-xs">|</span>}
