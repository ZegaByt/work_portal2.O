...
function PaymentAdminView() {
    ...
    }, [fetchCustomers, fetchEmployees, fetchGenders, fetchDropdownOptions]);
    ...
    const handleAddCustomer = async (e) => {
        ...
        try {
            ...
            if (errDetail.detail) {
                ...
                toast.error(Object.values(errDetail).flat().join(', ') || 'Failed to add customer');
            }
    ...
    const paymentFields = [
        ...
        'payment_admin_approval', 'bank_name', 'account_holder_name', 'agreement_status', 'agreement_file',
        'admin_agreement_approval', 'settlement_status', 'settlement_by', 'settlement_amount',
    ...
    return (
        <main className="p-0 sm:p-0 bg-gray-50 min-h-screen selection:bg-indigo-600 selection:text-white">
            <div className="max-w-6xl mx-auto">
                ...
                {/* Payment Details Edit Section */}
                {selectedCustomerData ? (
                    <div className="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-100 mt-10 animate-fadein">
                        ...
                        {saveSuccessMessage && <p className="text-green-600 text-sm mb-4">{saveSuccessMessage}</p>}
                    ...
                    <div className="text-center text-gray-500 py-10 border border-dashed rounded-md p-4 mt-10">
                        Please select a customer from the table above to view and edit their payment details.
                    </div>
                )}
